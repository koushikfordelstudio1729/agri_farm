...
exports.detectUserLanguage = exports.isLanguageSupported = exports.getLanguageInfo = exports.defaultTranslations = exports.i18nConfig = exports.translationNamespaces = exports.supportedLanguages = void 0;
...
exports.i18nConfig = {
    defaultLanguage: 'en',
    fallbackLanguage: 'en',
    supportedLanguages: exports.supportedLanguages.map(lang => lang.code),
    enabledLanguages: exports.supportedLanguages.filter(lang => lang.enabled).map(lang => lang.code),
    namespaces: exports.translationNamespaces.map(ns => ns.key),
...
const getLanguageInfo = (code) => {
    return exports.supportedLanguages.find(lang => lang.code === code);
};
exports.getLanguageInfo = getLanguageInfo;
const isLanguageSupported = (code) => {
    return exports.supportedLanguages.some(lang => lang.code === code && lang.enabled);
};
exports.isLanguageSupported = isLanguageSupported;
const detectUserLanguage = (acceptLanguageHeader) => {
    if (!acceptLanguageHeader) {
        return exports.i18nConfig.defaultLanguage;
    }
    ...
    for (const lang of preferredLanguages) {
        if (lang.code && (0, exports.isLanguageSupported)(lang.code)) {
            return lang.code;
        }
    }
    return exports.i18nConfig.defaultLanguage;
...
exports.default = exports.i18nConfig;
