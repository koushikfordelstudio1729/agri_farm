...
export type ValidatorType = 'email' | 'phone' | 'password' | 'url' | 'ip' | 'uuid' | 'mongoId' | 'creditCard' | 'postalCode' | 'coordinates' | 'date' | 'dateRange' | 'file' | 'image' | 'json' | 'base64' | 'custom';
...
//# sourceMappingURL=validators.types.d.ts.map