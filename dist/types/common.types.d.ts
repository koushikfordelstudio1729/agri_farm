...
export type LanguageCode = 'en' | 'es' | 'fr' | 'pt' | 'hi' | 'bn' | 'id' | 'vi';
...
export type NotificationType = 'diagnosis_complete' | 'expert_response' | 'weather_alert' | 'price_alert' | 'community_like' | 'community_comment' | 'system_update';
